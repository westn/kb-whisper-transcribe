...
export const RUNTIME_VERSION = "whispercpp-runtime-v0.1.1";
export const DEFAULT_RUNTIME_MANIFEST_URL =
  process.env.KB_WHISPER_RUNTIME_MANIFEST_URL ??
  "https://github.com/westn/kb-whisper-transcribe/releases/download/whispercpp-runtime-v0.1.1/runtime-manifest.json";
